...
// 		vars["relWhere"] = `JOIN muts_relations rl ON rl.from_id = r.id AND ` + strings.Join(b.relFilters, ` AND `)
// 	}
...
// `
// const qRelJoin = `
// LEFT JOIN muts_relations rels ON rels.from_id = r.id
// `
// const qRelGroup = `
// GROUP BY r.id;
// `
...
// `
// const qRecJoin = `
// INNER JOIN muts_records recs ON rels.to_id = recs.id
// `
